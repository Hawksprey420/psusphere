...
SECRET_KEY = 'django-insecure-$ev8bw+g%ry0&x&gf4!kf1_=w0w8t46uf_+y_#75_cu110934-'
...
LOGIN_REDIRECT_URL = '/'      # where @login_required will send users # where to go after successful login 
